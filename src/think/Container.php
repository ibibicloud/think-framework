...
class Container implements ArrayAccess, IteratorAggregate, Countable
{
    ...
    public function invokeFunction($function, $vars = [])
    {
        try {
            ...
            throw new Exception('函数不存在: ' . $function . '()');
        }
    }
    ...
    public function invokeMethod($method, $vars = [])
    {
        try {
            ...
            throw new Exception('方法不存在: ' . (is_array($method) ? $method[0] . '::' . $method[1] : $method) . '()');
        }
    }
    ...
    public function invokeClass($class, $vars = [])
    {
        try {
            ...
            throw new ClassNotFoundException('类不存在: ' . $class, $class);
        }
    }
    ...
    protected function parseParams($params, $vars, $type)
    {
        foreach ( $params as $param ) {
            ...
            if ( $class ) {
                ...
                throw new InvalidArgumentException('方法参数错误:' . $name);
            }
        }
        return $args;
    }
